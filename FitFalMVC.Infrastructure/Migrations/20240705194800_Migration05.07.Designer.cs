...
namespace FitFalMVC.Infrastructure.Migrations
{
    ...
    [Migration("20240705194800_Migration05.07")]
    partial class Migration0507
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitFalMVC.Domain.Model.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitFalMVC.Domain.Model.WorkoutExercise", b =>
                {
                    ...
                    b.HasOne("FitFalMVC.Domain.Model.Exercise", "Exercise")
                        .WithMany("WorkoutExercises")
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FitFalMVC.Domain.Model.Workout", "Workouts")
                        .WithMany("WorkoutExercises")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FitFalMVC.Domain.Model.ApplicationUser", null)
                        .WithMany()
